-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\lms\lms_filter_ipcore_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: lms_filter_ipcore_addr_decoder
-- Source Path: lms_filter_ipcore/lms_filter_ipcore_axi_lite/lms_filter_ipcore_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY lms_filter_ipcore_addr_decoder IS
  PORT( clk                               :   IN    std_logic;
        ...
        read_e_k                          :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En23
        read_o_k                          :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En23
        data_read                         :   OUT   std_logic_vector(31 DOWNTO 0);  -- ufix32
        write_axi_enable                  :   OUT   std_logic;  -- ufix1
        strobe_cop_in_strobe              :   OUT   std_logic;  -- ufix1
        write_x_k                         :   OUT   std_logic_vector(23 DOWNTO 0);  -- sfix24_En23
        write_d_k                         :   OUT   std_logic_vector(23 DOWNTO 0)  -- sfix24_En23
        );
END lms_filter_ipcore_addr_decoder;


ARCHITECTURE rtl OF lms_filter_ipcore_addr_decoder IS
  ...
  SIGNAL read_e_k_signed                  : signed(23 DOWNTO 0);  -- sfix24_En23
  SIGNAL cop_reg_strobe_1                 : std_logic;  -- ufix1
  SIGNAL read_o_k_signed                  : signed(23 DOWNTO 0);  -- sfix24_En23
  SIGNAL cop_reg_strobe_2                 : std_logic;  -- ufix1
  SIGNAL decode_sel_o_k                   : std_logic;  -- ufix1
  ...
  SIGNAL sync_reg_e_k                     : signed(23 DOWNTO 0);  -- sfix24_En23
  SIGNAL data_in_e_k                      : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_e_k                    : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL sync_reg_o_k                     : signed(23 DOWNTO 0);  -- sfix24_En23
  SIGNAL data_in_o_k                      : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_o_k                    : unsigned(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL data_in_x_k                      : signed(23 DOWNTO 0);  -- sfix24_En23
  SIGNAL decode_sel_x_k                   : std_logic;  -- ufix1
  SIGNAL reg_enb_x_k                      : std_logic;  -- ufix1
  SIGNAL write_reg_x_k                    : signed(23 DOWNTO 0);  -- sfix24_En23
  SIGNAL data_in_d_k                      : signed(23 DOWNTO 0);  -- sfix24_En23
  SIGNAL decode_sel_d_k                   : std_logic;  -- ufix1
  SIGNAL reg_enb_d_k                      : std_logic;  -- ufix1
  SIGNAL write_reg_d_k                    : signed(23 DOWNTO 0);  -- sfix24_En23
...
BEGIN
  ...
  read_o_k_signed <= signed(read_o_k);

  cop_reg_strobe_2 <= cop_reg_strobe;

  
  decode_sel_o_k <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0043#, 14) ELSE
      '0';
  ...
  BEGIN
    IF reset = '1' THEN
      sync_reg_e_k <= to_signed(16#000000#, 24);
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  reg_o_k_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      sync_reg_o_k <= to_signed(16#000000#, 24);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' AND cop_reg_strobe_2 = '1' THEN
        sync_reg_o_k <= read_o_k_signed;
      END IF;
    END IF;
  END PROCESS reg_o_k_process;


  data_in_o_k <= unsigned(resize(sync_reg_o_k, 32));

  
  decode_rd_o_k <= decode_rd_e_k WHEN decode_sel_o_k = '0' ELSE
      data_in_o_k;

  data_read <= std_logic_vector(decode_rd_o_k);
  ...
  data_in_x_k <= signed(data_write_unsigned(23 DOWNTO 0));
  ...
  BEGIN
    IF reset = '1' THEN
      write_reg_x_k <= to_signed(16#000000#, 24);
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  data_in_d_k <= signed(data_write_unsigned(23 DOWNTO 0));
  ...
  BEGIN
    IF reset = '1' THEN
      write_reg_d_k <= to_signed(16#000000#, 24);
    ELSIF clk'EVENT AND clk = '1' THEN
